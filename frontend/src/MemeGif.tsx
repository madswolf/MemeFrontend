...
export const MemeGif: React.FC<{ memeState: MemeCanvasState; className: string; children: (Element | ReactNode) }> = (props) => {
  return (
      ...
      <>
        <div className="Meme-canvas-container">
          <div className="Meme-gif-container">
            ...
            <img
              className="Meme-gif"
              src={props.memeState.visualFileURL}
              alt="Gif-displaying-current-visual-meme"
            />
