...
import {  useMemeStackState } from './State';
...
const MemePage :React.FC = (props) =>{
    ...
    async function getRandom(){
        ...
        append({
            toptext:toptextResource,
            bottomtext:bottomtextResource,
            visualFileURL:visualResource,
            soundFileURL:soundResource,
            isGif:visualResource.endsWith('.gif')
        });
    }
